...
Machine learning models are increasingly being deployed in high-stakes settings, from healthcare to criminal justice.
...
<center><img src="images/xai_intro.png" class="responsive-img"></center>
...
<center><img src="images/xai_hypercube.png" class="responsive-img"></center>
...
<center><img src="images/xai_efficiency.png" class="responsive-img"></center>
...
While it's important that the estimator is right in expectation, we also care about how closely it concentrates around $\phi_i$.
...
\\&= \sum_{S \subseteq [d]: i \in S} \frac{v(S)}{d \binom{d-1}{|S|-1}}
- \sum_{S \subseteq [d]: i \notin S} \frac{v(S)}{d \binom{d-1}{|S|}}
\\&= \sum_{S \subseteq [d]} v(S) \left(\frac{\mathbb{1}[i \in S]}{d \binom{d-1}{|S|-1}}
...
(If not, we could subtract $v(\emptyset)$ from all values to center them without changing the Shapley values.)
...
\end{align}
$$
where we define $\mathbf{b} = \mathbf{b'} - \mathbf{A}' \mathbf{1} \frac{v([d])}{d}$,
we define $\mathbf{A}= \mathbf{A}' \mathbf{P}$,
...
<center><img src="images/xai_subsample.png" class="responsive-img"></center>
...
\| \boldsymbol{\Pi} \mathbf{A} \boldsymbol{\beta} - \boldsymbol{\Pi} \mathbf{b} \|^2
...
<center><img src="images/xai_leverage.png" class="responsive-img"></center>
