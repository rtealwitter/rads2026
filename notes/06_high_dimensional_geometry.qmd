...
To see why, consider a probability density function $p: \mathbb{R}^d \rightarrow \mathbb{R}$, with two key properties:
...
For a phenomenal explanation of this derivation (often called the Herschel-Maxwell derivation), check out [this](https://www.youtube.com/watch?v=cy8r7WSuT1I&ab_channel=3Blue1Brown) 3Blue1Brown video.
...
\end{align}
for some constant $c$.
The proof uses a concentration inequality for Chi-squared variables and is left as an exercise.
